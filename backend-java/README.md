...
- `CEOS_DB_URL=jdbc:mysql://localhost:3306/ceos_brand?useSSL=false&serverTimezone=UTC`
- `CEOS_DB_USERNAME=root`
- `CEOS_DB_PASSWORD=`

La tabla `users` ya existe en [backend/sql/ceos_brand.sql](/c:/Users/aespu/Downloads/ceos-brand-angular-base/ceos-brand/backend/sql/ceos_brand.sql).
